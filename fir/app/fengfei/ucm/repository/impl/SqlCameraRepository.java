...
public class SqlCameraRepository implements CameraRepository {
    ...
    @Override
    public boolean add(final List<Camera> models, final int idUser) throws DataAccessException {
    ...
    @Override
    public List<Camera> select(final int idUser) throws DataAccessException {
        try {
    ...
    @Override
    public List<Camera> selectForSorted(final int idUser) throws DataAccessException {
        try {
    ...
    @Override
    public ListMultimap<String, Camera> selectGroup(final int idUser) throws DataAccessException {
        try {
