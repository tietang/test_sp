...
public class PhotoSetDao {
    ...
    public static int delete(
            ForestGrower grower, String suffix, long idSet,
    ...
    public static int deleteUserPhotoSetsById(
            ForestGrower grower,
    ...
    public static List<PhotoSet> selectUserSets(
            ForestGrower grower,
    ...
    public static PhotoSet getPhotoSet(
    ...
    public static long getPhotoSetId(
            ForestGrower grower, String suffix,
            long idPhoto, Integer idUser) throws SQLException {
    ...
    public static List<Long> selectSetPhoto(
            ForestGrower grower, String suffix,
    ...
    public static int addPhotoSets(
            ForestGrower grower, String suffix,
    ...
    public static int updatePhotoSets(
            ForestGrower grower, String suffix,
    ...
    public static int countUserPhotoSet(
            ForestGrower grower, String suffix,
            Integer idUser) throws SQLException {
    ...
    public static int deletePhotoSets(
            ForestGrower grower, String suffix,
