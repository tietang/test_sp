...
public class PhotoDao {
    ...
    final static String Insert = "INSERT INTO photo%s"
            + "(id_photo, id_user, title, `desc`, category, adult,copyright,tags,create_at, create_at_gmt, update_at, status,comment_count, original_at,"
    ...
    final static String Update = "update photo%s"
            ...
            + " title=?, `desc`=?,category=?,adult=?,copyright=?,tags=?,update_at=?,status=? "
    ...
    public static Photo selectOne(ForestGrower grower, String suffix, long idPhoto, long idUser)
            throws SQLException {
        String sql = "SELECT id_photo,id_user,nice_name,title,`desc`,category,create_at,create_at_gmt,update_at,status,comment_count,adult,copyright,tags,make,model,lens,aperture,shutter,iso,focus,ev,original_at,white_balance,software,flash,color_space,metering_mode,exposure_mode,exposure_program,gps_latitude,gps_longitude,gps_altitude,gps_origin,ip"
                + " FROM photo" + suffix + " WHERE id_photo=? and id_user=?";
        Photo exifModel = grower.selectOne(sql, new PhotoTransducer(), idPhoto, idUser);
        return exifModel;
    ...
    public static Photo selectOne(ForestGrower grower, String suffix, long idPhoto)
            throws SQLException {
        String sql = "SELECT id_photo,id_user,nice_name,title,`desc`,category,create_at,create_at_gmt,update_at,status,comment_count,adult,copyright,tags,make,model,lens,aperture,shutter,iso,focus,ev,original_at,white_balance,software,flash,color_space,metering_mode,exposure_mode,exposure_program,gps_latitude,gps_longitude,gps_altitude,gps_origin,ip"
                + " FROM photo" + suffix + " WHERE id_photo=? ";
