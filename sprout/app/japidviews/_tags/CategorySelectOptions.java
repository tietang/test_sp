...
// - end of implicit fields with Play 
	...
	public CategorySelectOptions(cn.bran.japid.template.JapidTemplateBaseWithoutPlay caller) {
		super(caller);
	}
...
////// end of named args stuff
	...
	public cn.bran.japid.template.RenderResult render(Map kv,Byte defaultKey) {
		...
		try {super.layout();} catch (RuntimeException __e) { super.handleException(__e);} // line 2, japidviews/_tags/CategorySelectOptions.html
...
if(key.equals(defaultKey)){// line 13, japidviews\_tags\CategorySelectOptions.html
		p("\n" + 
"<option selected=\"selected\" value=\"");// line 13, japidviews\_tags\CategorySelectOptions.html
		...
		p("\n" + 
"<option value=\"");// line 15, japidviews\_tags\CategorySelectOptions.html
