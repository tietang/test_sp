...
public abstract class Layout_Old extends cn.bran.play.JapidTemplateBase
{
	...
	public void layout() {
		...
		p(lookupStatic("/public/stylesheets/reset.css"));// line 6
		p("\">\n" +
				"<link rel=\"stylesheet\" media=\"screen\" href=\"");// line 6
		p(lookupStatic("/public/stylesheets/layout.css"));// line 7
		p("\">\n" +
				"<link rel=\"shortcut icon\" type=\"image/png\" href=\"");// line 7
		p(lookupStatic("/public/images/favicon.png"));// line 8
		p("\">\n" +
				"<script src=\"");// line 8
		p(lookupStatic("/public/javascripts/jquery-1.7.2.js"));// line 9
		...
		p("					</ul>\n" +
				...
				"			</div>\n" +
				"		</div>\n" +
				"		<div id=\"spruce_body\" class=\"container-960\">");// line 81
		doLayout();// line 88
		p("</div>\n"
				+
				"\n"
