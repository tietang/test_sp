...
public abstract class Layout3 extends cn.bran.play.JapidTemplateBase
{
	...
	public void layout() {
		...
		title();
		p("</title>\n" +
				"		<link rel=\"stylesheet\" href=\"");// line 5
		p(lookupStatic("/public/52framework/css/reset.css"));// line 6
		p("\" type=\"text/css\"  />\n" +
				"		<link rel=\"stylesheet\" href=\"");// line 6
		p(lookupStatic("/public/52framework/css/css3.css"));// line 7
		p("\"  type=\"text/css\" media=\"screen\" />\n" +
				"		<link rel=\"stylesheet\" href=\"");// line 7
		p(lookupStatic("/public/52framework/css/general.css"));// line 8
		p("\"  type=\"text/css\" media=\"screen\" />\n" +
				"		<link rel=\"stylesheet\" href=\"");// line 8
		p(lookupStatic("/public/52framework/css/grid1200.css"));// line 9
		p("\" type=\"text/css\" />\n" +
				"\n" +
				"		<link rel=\"stylesheet\" href=\"");// line 9
		p(lookupStatic("/public/basic/css/bootstrap.css"));// line 11
		p("\" type=\"text/css\" />\n" +
				"		<link rel=\"stylesheet\" href=\"");// line 11
		p(lookupStatic("/public/52framework/css/wb3.css"));// line 12
		p("\" type=\"text/css\" />\n" +
				"		<!--[if (gte IE 6)&(lte IE 8)]>\n" +
				"		<script src=\"");// line 12
		p(lookupStatic("/public/52framework/js/selectivizr.js"));// line 14
		p("\"></script>\n" +
				"		<![endif]-->\n" +
				"		<script src=\"");// line 14
		p(lookupStatic("/public/js/jquery-1.10.1.js"));// line 16
		p("\"></script>\n" +
				"		<script src=\"");// line 16
		p(lookupStatic("/public/js/jquery-migrate-1.2.1.js"));// line 17
		p("\"></script>\n" +
				"		<script src=\"");// line 17
		p(lookupStatic("/public/52framework/js/modernizr-1.7.min.js"));// line 18
		p("\"></script><!-- this is the javascript allowing html5 to run in older browsers -->\n"
				+
				"		<script src=\"");// line 18
		p(lookupStatic("/public/js/jquery-1.10.1.js"));// line 19
		p("\"></script>\n" +
				"		<script src=\"");// line 19
		p(lookupStatic("/public/js/jquery-migrate-1.2.1.js"));// line 20
		p("\"></script>\n" +
				"		<script src=\"");// line 20
		p(lookupStatic("/public/basic/js/bootstrap.js"));// line 21
		p("\"></script>\n" +
				"		");// line 21
		css();
		p("	</head>\n"
