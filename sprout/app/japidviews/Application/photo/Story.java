...
public class Story extends japidviews._layouts.Layout
{
	...
	protected void doLayout() {
		...
		_AddNav3.render("story"); // line 112// line 112
		p("\n"
				+
				...
				"			<div class=\"help  edit\">\n" +
				"				<img src=\"");// line 112
		p(lookupStatic("/public/images/stories_edit.png"));// line 127
		p("\" />\n"
				+
				"				<div  >\n"
				+
	...
	protected void css() {
		...
		p(lookupStatic("/public/blueimp/css/jquery.fileupload-ui.css"));// line 9
		p("\">\n" +
				"<script src=\"");// line 9
		p(lookupStatic("/public/blueimp/js/vendor/jquery.ui.widget.js"));// line 10
		p("\"></script>\n" +
				"<script src=\"");// line 10
		p(lookupStatic("/public/blueimp/load-image.min.js"));// line 11
		p("\"></script>\n" +
				"<script src=\"");// line 11
		p(lookupStatic("/public/blueimp/tmpl.min.js"));// line 12
		p("\"></script>\n" +
				"<script src=\"");// line 12
		p(lookupStatic("/public/blueimp/canvas-to-blob.min.js"));// line 13
		p("\"></script>\n" +
				"<script src=\"");// line 13
		p(lookupStatic("/public/blueimp/js/jquery.iframe-transport.js"));// line 14
		p("\"></script>\n" +
				"<script src=\"");// line 14
		p(lookupStatic("/public/blueimp/js/jquery.fileupload.js"));// line 15
		p("\"></script>\n" +
				"<script src=\"");// line 15
		p(lookupStatic("/public/blueimp/js/jquery.fileupload-process.js"));// line 16
		p("\"></script>\n" +
				"<script src=\"");// line 16
		p(lookupStatic("/public/blueimp/js/jquery.fileupload-image.js"));// line 17
		p("\"></script>\n" +
				"<script src=\"");// line 17
		p(lookupStatic("/public/blueimp/js/jquery.fileupload-validate.js"));// line 18
		p("\"></script>\n" +
				"<script src=\"");// line 18
		p(lookupStatic("/public/js/binaryajax.js"));// line 19
		p("\"></script>\n" +
				"<script src=\"");// line 19
		p(lookupStatic("/public/js/exif.js"));// line 20
		p("\"></script>\n" +
				"<script src=\"");// line 20
		p(lookupStatic("/public/app/ExifUtils.js"));// line 21
		p("\"></script>\n" +
				"<script src=\"");// line 21
		p(lookupStatic("/public/app/jquery.fileupload-ui-sprucy.js"));// line 22
		p("\"></script>\n" +
				"<script src=\"");// line 22
		p(lookupStatic("/public/app/story.js"));// line 23
		p("\"></script>\n" +
				"<style type=\"text/css\">\n" +
				"	.left {\n" +
				"		text-align: left;\n" +
