...
public class UploadSwf extends japidviews._layouts.Layout
{
	...
	protected void css() {
		p("<style type=\"text/css\">\n" +
				...
				"</style>\n" +
				"<script src=\"");// line 2
		p(lookupStatic("/public/agile-uploader-3.0/jquery.flash.min.js"));// line 34
		p("\" type=\"text/javascript\"></script>\n" +
				"\n" +
				"<script src=\"");// line 34
		p(lookupStatic("/public/agile-uploader-3.0/agile-uploader-3.1.js"));// line 36
		p("\" type=\"text/javascript\"></script>\n" +
				"<link type=\"text/css\" rel=\"stylesheet\" href=\"");// line 36
		p(lookupStatic("/public/agile-uploader-3.0/agile-uploader.css"));// line 37
		p("\" />\n" +
				"<script src=\"");// line 37
		p(lookupStatic("/public/app/ExifUtils.js"));// line 38
		p("\"></script>\n" +
				"<script src=\"");// line 38
		p(lookupStatic("/public/app/upload.js"));// line 39
		p("\"></script>\n");// line 39
		;
	}
}
