...
public class Category extends japidviews._layouts.Layout
{
	...
	private Map<String, String> pathTitle; // line 3
	...
	protected void doLayout() {
		...
		_PhotoNav3.render(pagePath, pathTitle); // line 10// line 10
		final PhotoView _PhotoView4 = new PhotoView(getOut());
		_PhotoView4.setActionRunners(getActionRunners()).setOut(getOut());
		_PhotoView4.render(pagePath, photos, pageNum); // line 11// line 11
	...
	protected void css() {
		p("<!---->\n" +
				"<link rel=\"stylesheet\" type=\"text/css\" href=\"");// line 6
		p(lookupStatic("/public/styles/photo.css"));// line 8
		p("\"/>\n");// line 8
		;
	}
