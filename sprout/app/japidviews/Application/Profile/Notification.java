...
public class Notification extends japidviews._layouts.Layout
{
	...
	protected void doLayout() {
		...
		_SettingsMenu2.render("Notifications"); // line 11// line 11
		p("        </div>\n"
				+
				"    </div>\n"
				+
				...
				"                            ");// line 11
		;
		p(getMessage("notify.comment.wall"));// line 24
		p(" </label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 24
		;
		p(getMessage("notify.comment.photo"));// line 31
		p(" </label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 31
		;
		p(getMessage("notify.comment.story"));// line 39
		p(" </label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 39
		;
		p(getMessage("notify.favorite.photo"));// line 47
		p(" </label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 47
		;
		p(getMessage("notify.choice.photo"));// line 55
		p("</label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 55
		;
		p(getMessage("notify.score.up"));// line 63
		p("</label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 63
		;
		p(getMessage("notify.follow.me"));// line 71
		p(" </label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 71
		;
		p(getMessage("notify.subscribed"));// line 79
		p("</label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 79
		;
		p(getMessage("notify.buy.photo"));// line 87
		p(" </label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 87
		;
		p(getMessage("notify.news"));// line 94
		p("</label>\n"
				+
				"                    </div>\n"
				+
				...
				"                            ");// line 94
		;
		p(getMessage("notify.account.change"));// line 102
		p("</label>\n"
				+
				"                    </div>\n"
				+
				...
				"                                ");// line 102
		;
		p(getMessage("save.change"));// line 108
		p("                            </button>\n" +
				"                        </div>\n" +
				"                    </div>\n" +
				"\n" +
