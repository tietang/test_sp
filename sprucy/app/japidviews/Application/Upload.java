...
//
// NOTE: This file was generated from: japidviews/Application/Upload.html
// Change to this file will be lost next time the template file is compiled.
//
@cn.bran.play.NoEnhance
public class Upload extends cn.bran.play.JapidTemplateBase
{
	public static final String sourceTemplate = "japidviews/Application/Upload.html";
	{
 ...
 */
	...
	public static java.lang.reflect.Method renderMethod = getRenderMethod(japidviews.Application.Upload.class);
...
"<!-- <link rel=\"stylesheet\" media=\"screen\" href=\"");// line 10
		p(lookupStatic("/public/css/ui-darkness/jquery-ui-1.10.2.custom.css"));// line 11
		p("\"> -->\n" + 
"<link rel=\"stylesheet\" media=\"screen\" href=\"");// line 11
		p(lookupStatic("/public/bootstrap/css/bootstrap.min.css"));// line 12
		p("\">\n" + 
"<!-- <link rel=\"stylesheet\" media=\"screen\" href=\"");// line 12
		p(lookupStatic("/public/css/form.css"));// line 13
		p("\"> -->\n" + 
"<!-- Shim to make HTML5 elements usable in older Internet Explorer versions -->\n" + 
"<!--[if lt IE 9]><script src=\"");// line 13
		p(lookupStatic("/public/js/html5shiv.js"));// line 15
		p("\"></script><![endif]-->\n" + 
"<script src=\"");// line 15
		p(lookupStatic("/public/js/jquery-1.9.1.js"));// line 16
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 16
		p(lookupStatic("/public/bootstrap/js/bootstrap.min.js"));// line 17
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 17
		p(lookupStatic("/public/js/jquery-ui-1.10.2.custom.min.js"));// line 18
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 18
		p(lookupStatic("/public/js/blueimp/tmpl.js"));// line 19
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 19
		p(lookupStatic("/public/js/blueimp/load-image.min.js"));// line 20
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 20
		p(lookupStatic("/public/js/blueimp/canvas-to-blob.min.js"));// line 21
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 21
		p(lookupStatic("/public/js/blueimp/jquery.iframe-transport.js"));// line 22
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 22
		p(lookupStatic("/public/js/blueimp/jquery.fileupload.js"));// line 23
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 23
		p(lookupStatic("/public/js/blueimp/jquery.fileupload-fp.js"));// line 24
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 24
		p(lookupStatic("/public/app/ExifUtils.js"));// line 25
		p("\" type=\"text/javascript\"></script>\n" + 
"<!--<script src=\"");// line 25
		p(lookupStatic("/public/js/blueimp/jquery.fileupload-ui.js"));// line 26
		p("\" type=\"text/javascript\"></script> -->\n" + 
"\n" + 
" <script src=\"");// line 26
		p(lookupStatic("/public/js/jquery.fileupload-ui-sprucy.js"));// line 28
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 28
		p(lookupStatic("/public/js/binaryajax.js"));// line 29
		p("\" type=\"text/javascript\"></script>\n" + 
"<script src=\"");// line 29
		p(lookupStatic("/public/js/exif.js"));// line 30
		p("\" type=\"text/javascript\"></script>\n" + 
"\n" + 
"<script src=\"");// line 30
		p(lookupStatic("/public/app/u.js"));// line 32
		p("\" type=\"text/javascript\"></script>\n" + 
"<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE8+ -->\n" + 
"<!--[if gte IE 8]><script src=\"");// line 32
		p(lookupStatic("/public/js/blueimp/cors/jquery.xdr-transport.js"));// line 34
		p("\"></script><![endif]-->\n" + 
"\n" + 
"\n" + 
"<style type=\"text/css\">\n" + 
