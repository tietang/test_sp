...
//
// NOTE: This file was generated from: japidviews/Application/Upload1.html
// Change to this file will be lost next time the template file is compiled.
//

public class Upload1 extends cn.bran.play.JapidTemplateBase
{
	public static final String sourceTemplate = "japidviews/Application/Upload1.html";
	{
	...
	public static java.lang.reflect.Method renderMethod = getRenderMethod(japidviews.Application.Upload1.class);
	...
	protected void doLayout() {
		...
		p("\" type=\"text/javascript\"></script>\n" +
				"<!-- <script src=\"");// line 18
		p(lookupStatic("/public/javascripts/blueimp/tmpl.js"));// line 19
		p("\" type=\"text/javascript\"></script> -->\n" +
				"<script src=\"");// line 19
		p(lookupStatic("/public/javascripts/blueimp/load-image.min.js"));// line 20
		p("\" type=\"text/javascript\"></script>\n" +
				"<script src=\"");// line 20
		p(lookupStatic("/public/javascripts/blueimp/jquery.iframe-transport.js"));// line 21
		p("\" type=\"text/javascript\"></script>\n" +
				"<script src=\"");// line 21
		p(lookupStatic("/public/javascripts/blueimp/jquery.fileupload.js"));// line 22
		p("\" type=\"text/javascript\"></script>\n" +
				"<script src=\"");// line 22
		p(lookupStatic("/public/javascripts/blueimp/jquery.fileupload-fp.js"));// line 23
		p("\" type=\"text/javascript\"></script>\n" +
				"<!-- <script src=\"");// line 23
		p(lookupStatic("/public/javascripts/blueimp/jquery.fileupload-ui.js"));// line 24
		p("\" type=\"text/javascript\"></script> -->\n" +
				"\n" +
				"<script src=\"");// line 24
		p(lookupStatic("/public/app/u1.js"));// line 26
		p("\" type=\"text/javascript\"></script>\n"
				+
				"<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE8+ -->\n"
				+
				"<!--[if gte IE 8]><script src=\"");// line 26
		p(lookupStatic("/public/javascripts/blueimp/cors/jquery.xdr-transport.js"));// line 28
		p("\"></script><![endif]-->\n" +
				"\n" +
				"<style type=\"text/css\">\n" +
				"html,body {\n" +
				...
				".ui-progressingbar {\n" +
				"	height: 18px;\n" +
				"	background-image: url(");// line 28
		p(lookupStatic("/public/img/progressbar.gif"));// line 37
		p("\n"
				+
				"\n"
				+
