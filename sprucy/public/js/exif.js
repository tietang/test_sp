/*
 * Javascript EXIF Reader 0.1.4 Copyright (c) 2008 Jacob Seidelin,
 * cupboy@gmail.com, http://blog.nihilogic.dk/ Licensed under the MPL License
...
(function() {
	...
	EXIF.Tags = {
		...
		0xA408 : "Contrast", // Direction of contrast processing applied by
								// camera
		0xA409 : "Saturation", // Direction of saturation processing applied by
								// camera
		0xA40A : "Sharpness", // Direction of sharpness processing applied by
								// camera
	...
	function readTagValue(oFile, iEntryOffset, iTIFFStart, iDirStart, bBigEnd) {
		...
		switch (iType) {
			...
			case 2 : // ascii, 8-bit byte
				var iStringOffset = iNumValues > 4
						? iValueOffset
						: (iEntryOffset + 8);
	...
	function readEXIFData(oFile, iStart, iLength) {
		...
		if (oFile.getLongAt(iTIFFOffset + 4, bBigEnd) != 0x00000008) {
			if (bDebug)
				console.log("Not valid TIFF data! (First offset not 8)", oFile
								.getShortAt(iTIFFOffset + 4, bBigEnd));
			return false;
		}
